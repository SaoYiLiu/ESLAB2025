/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_1764519189663_H
#define AI_NETWORK_1764519189663_H

#include "network_1764519189663_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1764519189663_MODEL_NAME          "network_1764519189663"
#define AI_NETWORK_1764519189663_ORIGIN_MODEL_NAME   "model_64_gray_float"

/******************************************************************************/
#define AI_NETWORK_1764519189663_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_1764519189663_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_1764519189663_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_1764519189663_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1764519189663_IN \
  ai_network_1764519189663_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1764519189663_IN_SIZE { \
  AI_NETWORK_1764519189663_IN_1_SIZE, \
}
#define AI_NETWORK_1764519189663_IN_SIZE_BYTES { \
  AI_NETWORK_1764519189663_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1764519189663_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_1764519189663_IN_1_HEIGHT      (64)
#define AI_NETWORK_1764519189663_IN_1_WIDTH       (64)
#define AI_NETWORK_1764519189663_IN_1_CHANNEL     (1)
#define AI_NETWORK_1764519189663_IN_1_SIZE        (4096)
#define AI_NETWORK_1764519189663_IN_1_SIZE_BYTES  (16384)

/******************************************************************************/
#define AI_NETWORK_1764519189663_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1764519189663_OUT \
  ai_network_1764519189663_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1764519189663_OUT_SIZE { \
  AI_NETWORK_1764519189663_OUT_1_SIZE, \
}
#define AI_NETWORK_1764519189663_OUT_SIZE_BYTES { \
  AI_NETWORK_1764519189663_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1764519189663_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_1764519189663_OUT_1_CHANNEL     (3)
#define AI_NETWORK_1764519189663_OUT_1_SIZE        (3)
#define AI_NETWORK_1764519189663_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_NETWORK_1764519189663_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1764519189663
 ...
 * @ref ai_network_1764519189663_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1764519189663_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1764519189663_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1764519189663_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1764519189663_*
 * defines into file @ref network_1764519189663.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1764519189663_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1764519189663_H */
